...
object TestAnsj {
  ...
  def main(args: Array[String]): Unit = {
    ...
    import org.ansj.splitWord.analysis.ToAnalysis
    System.out.println(BaseAnalysis.parse(str).toStringWithOutNature(","))
    System.out.println(ToAnalysis.parse(str).toStringWithOutNature(","))
    System.out.println(DicAnalysis.parse(str).toStringWithOutNature(","))
    System.out.println(IndexAnalysis.parse(str).toStringWithOutNature(","))
