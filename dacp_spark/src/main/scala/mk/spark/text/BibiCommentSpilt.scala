...
object BibiCommentSpilt {
  ...
  def main(args: Array[String]): Unit = {
    ...
    spark.sql("select  word,media_id ,sum(num) as  word_num from bibi_long_comments_words  group by  meida_id,word")
...
case class  MediaWordNumber(word: String,media_id:String,num:Int)
